module.exports = (subject,name,code) => `<!DOCTYPE html>
<html>
<head>
  <style>
    body {
...
<body>
  <div class="email-container">
    ...
    <div class="email-body">
      <h2>Hello ${name},</h2>
      <p>Thank you for signing up with E-commerce App. To complete your registration and start using your account, please get code to activate your account:</p>
